//isInArray
export function isInArray(arr: Array<any>, ...rest: Array<any>): boolean {
...
//summator
export function summator(...rest: Array<number | string>): number {
  let result = 0;
  rest.forEach((item) => {
    item = +item
    if (item) {
...
//getUnique
export function getUnique(arr: Array<any>): Array<any> {
